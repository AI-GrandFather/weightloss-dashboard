...
export default function DashboardClient({
  ...
  // Helper to re-fetch/re-calculate dashboard stats locally for the selectedDate
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans pb-16 selection:bg-indigo-500/30 selection:text-indigo-200">
      ...
      <header className="border-b border-slate-900 bg-slate-950/80 backdrop-blur sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-lg font-semibold tracking-tight bg-gradient-to-r from-white via-slate-200 to-slate-400 bg-clip-text text-transparent">
              WeightLoss MVP
            </h1>
          </div>
          ...
          <Button 
            ...
            className="text-slate-400 hover:text-slate-100 hover:bg-slate-900 flex items-center gap-2"
          >
      ...
      <main className="max-w-7xl mx-auto px-4 mt-8 space-y-8">
        ...
        {/* Date Selector bar */}
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 bg-slate-900/40 border border-slate-900 p-4 rounded-2xl backdrop-blur-md">
          <div className="flex items-center gap-2">
            <Calendar className="h-5 w-5 text-indigo-400" />
            <span className="font-medium text-slate-300">Target Date:</span>
            <input 
              type="date" 
              value={selectedDate}
          ...
          <div className="flex items-center gap-2">
            <Button 
              ...
              className="border-slate-800 hover:bg-slate-950 bg-slate-900/60"
            >
            ...
            <Button 
              ...
              className="border-slate-800 hover:bg-slate-950 bg-slate-900/60 font-medium px-4"
            >
              Today
            </Button>
            <Button 
          ...
          <Card className="border-slate-900 bg-slate-900/20 backdrop-blur-xl relative overflow-hidden">
            ...
            <CardContent>
              ...
              <p className="text-xs text-slate-500 mt-1">
                {stats.weightDate ? `Active since ${stats.weightDate}` : "No logged weight"}
              </p>
            </CardContent>
          </Card>
            ...
            <CardContent>
              ...
              <div className="w-full bg-slate-850 h-1.5 rounded-full mt-2 overflow-hidden">
                <div 
                  ...
                  style={{ width: `${Math.min(100, (stats.steps / 10000) * 100)}%` }}
                />
              </div>
        ...
        {/* Split Section: Forms on Left, Logs/Recent on Right */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          
          {/* Manual Entry Forms (5 Columns) */}
          <section className="lg:col-span-5 space-y-6">
            <h2 className="text-lg font-semibold text-slate-200 border-l-2 border-indigo-500 pl-2">
              Log Activity
            </h2>

            {/* Diet Log Form with AI Pipeline */}
            <Card className="border-slate-900 bg-slate-900/25">
              ...
              <form onSubmit={handleDietSubmit}>
                <CardContent className="space-y-4">
                  ...
                  {/* Estimation Results Panel / Edit macros form */}
                  {dietMacros && (
              ...
              <form onSubmit={handleExerciseSubmit}>
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div className="space-y-1.5">
                      <Label htmlFor="exDistance">Distance (km - optional)</Label>
                      <Input 
                        id="exDistance"
                        type="number"
                        step="0.01"
          ...
          {/* Chronological Activity Feed (7 Columns) */}
          <section className="lg:col-span-7 space-y-6">
            ...
            <div className="space-y-4">
              {/* If no logs exist at all for selectedDate */}
            ...
            {/* List of past 30 days history (summary of weight logs) */}
            <div className="pt-6">
              <h3 className="text-sm font-semibold text-slate-400 uppercase tracking-wider mb-3">
                Recent Weight History (Last 30 Logs)
              </h3>
